...
impl Processor {
    ...
    pub fn process_change_deposit_receipt_owner(
        ...
        check_deposit_receipt_address(
            program_id,
            deposit_receipt_info.key,
            &deposit_receipt.owner,
            &deposit_receipt.stake_pool,
            &deposit_receipt.base,
